        ...
        <van-tabs v-model="active" animated>
          ...
          <van-tab title="登录">
            ...
            <van-cell-group v-show="isShowNameLogin">
              ...
              />
              <van-field v-model="captcha" center clearable maxlength="4" placeholder="请输入验证码">
                <img
            ...
            <van-cell-group v-show="!isShowNameLogin">
              ...
              >
                <van-button
                  ...
                  type="primary"
                >发送验证码</van-button>
                <van-button v-else slot="button" size="small" type="primary">已发送{{countDown}}秒</van-button>
              </van-field>
            </van-cell-group>

            <!-- 登录按钮 -->
            <van-button type="info" size="large" style="margin-top:1rem" @click="Login(0)">登录</van-button>

            <!-- 切换登录方式 -->
            <div class="switchLogin" @click="switchLogin">{{switchLoginMsg}}</div>
          </van-tab>

          <!-- 注册 -->
          <van-tab title="注册">
            <van-cell-group>
              <van-field v-model="username_registered" clearable placeholder="请输入用户名" required />
              <van-field v-model="tel_registered" clearable placeholder="请输入手机号" required />
              <van-field
            ...
            <!-- 注册按钮 -->
            <van-button type="info" size="large" style="margin-top:1rem" @click="Login(1)">注册</van-button>
          </van-tab>
        </van-tabs>
